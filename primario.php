...
<div class="container text-center">
  <div class="row content">
	...
	<form role="form" name="seachform" method="post" action="resultadobuscapri.php " >
  <div class="form-group" >
    <label for="email">Digite o número do terminal: </label>
    <input type="text" class="form-control" name="buscapri" >
