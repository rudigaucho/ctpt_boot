...
$query = "update tbprimarios set eqn='$eqn',parp='$primario',ver='$vertical',hor='$horizontal',obs='$obs',tecnico='$tecnico',dat='$data',central='$central' where idterminal='$terminal'";

$sql = mysql_query($query);
if($sql)
{
  
  echo "<h2>Primário editado com sucesso!!</h2>";
